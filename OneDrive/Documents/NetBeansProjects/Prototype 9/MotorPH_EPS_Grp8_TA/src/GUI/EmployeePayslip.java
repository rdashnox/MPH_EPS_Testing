...
public class EmployeePayslip extends javax.swing.JFrame {
     ...
     */
    public EmployeePayslip(String eid, Connection connection) {
    initComponents();
    try {
        this.connection = connection;
        initializeDashboardByEid(eid); // Load employee by EID
    } catch (Exception ex) {
    ...
    employeeDetails = EmployeeDetails.loadByEid(eid, connection);
    
    if (employeeDetails != null) {
        // Initialize salary calculator
        this.salaryCalculator = new SalaryCalculator(connection); 
        
        // Initializes necesaary Financial Data
        this.allowances = new Allowances(employeeDetails.getEid());
        this.deductions = new Deductions(employeeDetails.getEid());
        this.incentives = new Incentives(employeeDetails.getEid());
